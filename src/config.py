image_dir = '/data/anand/Automorph_data/1000_kaggle_run/1000_kaggle_run_images/'
results_dir = '/data/anand/Automorph_data/1000_kaggle_run/1000_kaggle_run_results/'
...
batch_size = 20 #batch size for the gpu
